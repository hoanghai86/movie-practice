...
const ScheduleMovie = () => {
  ...
  // dùng hàm useEffect để nó chạy lần đầu tiên, bỏ hàm getScheduleCinema vào useEffect, truyền mã rạp đầu tiên vào hàm get, sau khi hàm get nó chạy call API thì set state lại, ở đây ta có hàm setListSchedule
